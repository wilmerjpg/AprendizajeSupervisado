...
Por última se elimnan las columnas que ya no se necesitan dado que su data ya fue vaciada en otras columnas para un mejor manejo y las columnas que manejan numeros enteros pero en un principio manejaban otro tipo de datos
```{r }
