...
Una vez realizada varias pruebas se detectó que los mejores atributos que se pueden utilizar en el modelo de regresion lineal para predecir el precio de la habitacion para hombres son
```{r }
...
Una vez realizada varias pruebas se detectó que los mejores atributos que se pueden utilizar en el modelo de regresion lineal para predecir el precio de la habitacion para mujeres son
```{r }
modelo1=lm(dataHombres$Precio~dataHombres$Tipo.de.Inmueble)
plot(dataHombres$Tipo.de.Inmueble,dataHombres$Precio)
abline(modelo1)
