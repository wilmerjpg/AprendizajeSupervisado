...
Al evaluar los 3 modelos implementados con la función **roc** del paquete **pROC**, y hacer plot del resultado, se puede observar que el gráfico de la curva ROC que presentó mayor area de por debajo de la curva fue el modelo basado en reglas de clasificacion, seguido por el modelo basado en k vecinos cercanos y por ultimo el modelo basado en arbol de decisiones. Dado estos resultados se puede concluir que la calidad de los modelos viene dada por el orden anteriormente ya mencionado, es decir, que el modelo de mayor calidad para el caso estudiado es el modelo basado en reglas de clasificacion, del cual tambien se puede destacar que obtuvo la mayor precision de todos la cual se puede osbservar luego de haber construido su matriz de confusion
